  ...
  return (
    <div className= "p-3 lg:p-5 rounded-[12px] border border-solid border-[#D9DCE2] mb-5 cursor-pointer">
      ...
      >   
        ...
        <div className= {`${isOpen && "bg-primaryColor text-white border-none"} rounded flex items-center justify-center w-7 h-7 lg:w-8 lg:h-8 border border-solid border-[#141F21]`}>
