        ...
        <section>
          <div className="container">
            <div className="xl:w-[470px] mx-auto">
              ...
              <p className="text__para text-center">Exceptional care for all. Our healthcare system delivers unparalleled expertise, from the lab to the clinic</p>
            </div>
              ...
              <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] mr-[50px] lg:mt-0 ">
                ...
                <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px] ">
                  ...
                  <div className= "flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px] ">
                    <img className= "w-[40px] h-[40px] object-cover rounded-[20px]" src={doctor10} />
                    <h4 className="text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700] text-headingColor ">Said AIT BEN ALI</h4>
                  </div>
                </div>
              </div>
